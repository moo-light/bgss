...
for (let i = 0; i < stockData.length; i++) {
    ...
    if (stockData[i]['x'].getDate() !== date.getDate()) {
        let randomLow = Math.random() * 5 + stockData[i]['low'] - 5;
        let randomHigh = Math.random() * 5 + stockData[i]['high'];
...
for (let i = 0; i < stockData1.length; i++) {
    ...
    if (stockData1[i]['x'].getDate() !== date1.getDate()) {
        let randomLow1 = Math.random() * 5 + stockData1[i]['low'] - 5;
        let randomHigh1 = Math.random() * 5 + stockData1[i]['high'];
