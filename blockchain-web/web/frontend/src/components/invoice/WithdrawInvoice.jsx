...
const WithdrawInvoice = () => {
  ...
  const { data, isLoading, error, refetch } = useMyWithdrawListQuery();
              ...
              <div className="container">
                ...
                <table className="table table-striped table-bordered ">
                  <tbody>
                      ...
                      <td>
                        ...
                        >
                          ...
                          <Box display="flex" flexDirection="column">
                            ...
                            >
                              {withdraw.productDTO?.productName} {withdraw.productDTO?.typeGold?.typeName}
                            </Typography>
                    ...
                    <tr>
                      <th scope="row">Recieve status</th>
                      <td>
                        <Label color="success">
