...
const TransactionInvoice = () => {
  ...
  const { data, isLoading, error } = useMyTransactionListQuery();
      ...
      <div className="transaction-invoice my-5">
        <div className="row d-flex justify-content-center mb-5">
          {transaction?.contract?.contractStatus === "DIGITAL_SIGNED" && (
            ...
            >
              <i className="fa fa-print"></i> Download Contract
            </button>
          )}
        </div>
        {transaction && (
          <div id="transaction_invoice" className="p-3 border border-secondary">
            <header className="clearfix">
              ...
              <h1>CONTRACT # {transaction.id}</h1>
              <div className="container">
                <h3 className="mb-4 mt-2 ml-3">Customer's Info</h3>
                ...
                <table className="table table-striped table-bordered ">
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <strong>
                          {transaction?.contract?.confirmingParty ?? "none"}
                        </strong>
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td
                        style={{
                          color:
                            transaction?.contract?.transactionType === "BUY"
                              ? "red"
                              : transaction?.contract?.transactionType === "SELL"
                              ? "green"
                              : "black",
                        }}
                      >
                        {transaction?.contract?.transactionType === "SELL" ? "+" : ""}
                        {currencyFormat(transaction?.contract?.totalCostOrProfit)}
                      </td>
                    </tr>
                    <tr>
                      <th scope="row">Status Contract</th>
                      <td
                ...
                <div className="col-md-6">
                  <div className="border border-dark p-3 text-center">
                    ...
                    <div className="signature-info">
                      ...
                      <p>
                        <b>Date: </b> 
                        {myDateFormat(transaction?.contract?.createdAt)}
                      </p>
                    </div>
                  </div>
                </div>
                <div className="col-md-6">
                  <div className="border border-dark p-3 text-center">
                    ...
                    <div className="stamp-info">
                      ...
                      <p>
                        <b>Date: </b> {myDateFormat(transaction?.contract?.createdAt)}
                      </p>
                    </div>
                  </div>
                </div>
